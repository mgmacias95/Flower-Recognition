...
\begin{table}[H]
  ...
  \hline
    \multirow{2}{*}{\textbf{Algoritmo}} & \multicolumn{3}{c||}{\textbf{Tasa de acierto} ($k=20$)} & \multicolumn{3}{c|}{\textbf{Tasa de acierto} ($k=200$)} \\
    \cline{2-7}
    & \textbf{SIFT} & \textbf{SURF} & \textbf{KAZE} & \textbf{SIFT} & \textbf{SURF} & \textbf{KAZE} \\
    \hline
    \textit{SVM one-vs-all} & $\qquad 0.63$ & $\qquad 0.45$ & $\qquad 0.61$ & $\qquad 0.71$ & $\qquad 0.76$ & $\qquad 0.80$ \\ 
    \textit{SVM one-vs-one} & $\qquad 0.63$ & $\qquad 0.45$ & $\qquad 0.61$ & $\qquad 0.78$ & $\qquad 0.76$ & $\qquad 0.80$ \\
    \textit{RF con bootsting} & $\qquad 0.65$ & $\qquad 0.45$ & $\qquad 0.61$ & $\qquad 0.75$ & $\qquad 0.71$ & $\qquad 0.73$ \\
    \textit{RF sin bootsting} & $\qquad 0.59$ & $\qquad 0.63$ & $\qquad 0.69$ & $\qquad 0.75$ & $\qquad 0.67$ & $\qquad 0.71$ \\
    \hline
  \end{tabular}
  \label{resSHAPE}
