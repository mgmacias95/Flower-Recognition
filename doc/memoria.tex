...
Este diccionario se ha realizado usando el algoritmo \textit{K-Means} para el clustering, realizando distintas ejecuciones cambiando el tamaño de $k$ en el intervalo $[20,1000]$. El tiempo de ejecución del clustering, dependiendo del tamaño, pero para $k=1000$ supone un tiempo de 30 minutos aproximadamente.
